    ...
    <main className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-32">
      ...
      <section className="flex flex-col items-center text-center space-y-8">
        <motion.div initial={{
          ...
          {/* <p className="text-lg text-yellow-100 max-w-2xl mx-auto leading-relaxed text-justify font-semibold">
            <span className="text-amber-500"> Test Strategy </span> 
            <span className="text-cyan-400">Test Planning and Delivery </span> 
            <span className="text-lime-300">designing scalable UI/mobile automation frameworks </span> 
            <span className="text-indigo-500">API and contract testing </span> 
            <span className="text-fuchsia-400">mocking and service virtualization </span> 
            <span className="text-yellow-300">database validation </span> 
            <span className="text-teal-200">test data management </span> 
            <span className="text-rose-500">test observability </span> 
            <span className="text-purple-500">cloud based and containerized test execution </span> 
      ...
      <section id="experience" className="scroll-mt-24 max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400">
            Track record of delivering high-quality software in fast-paced
            environments.
          </p>
        </div>
        <ExperienceTimeline />
      ...
      <footer id = "footer" className="border-t border-slate-800 pt-12 pb-8 text-center">
        ...
        <p className="text-5xl text-white text-left text-slate-500 mb-4">
          Let's Talk
        </p>
        <p className="text-2xl text-white text-left text-slate-500 mb-4">
          hemendravishnoi@gmail.com
        </p>
        </div>
        <div className="text-slate-500 text-left md:text-right">
        <p className="text-right text-slate-500 mb-4">
          Built with React, Tailwind, and Framer Motion.
        </p>
        <p className="text-right text-slate-600 text-sm">
          © {new Date().getFullYear()} QA.Dev Portfolio. All rights reserved.
        </p>
        </div>
        </div>
      </footer>
